  ...
  async updateDelivery(id: string, input: UpdateDeliveryInput): Promise<Result<Delivery>> {
    try {
      ...
      const updated: Delivery = {
        ...
        scheduled_delivery: input.scheduled_delivery ?? delivery.scheduled_delivery,
        delay_threshold_minutes: input.delay_threshold_minutes ?? delivery.delay_threshold_minutes,
        auto_check_traffic: input.auto_check_traffic ?? delivery.auto_check_traffic,
        enable_recurring_checks: input.enable_recurring_checks ?? delivery.enable_recurring_checks,
        check_interval_minutes: input.check_interval_minutes ?? delivery.check_interval_minutes,
        max_checks: input.max_checks ?? delivery.max_checks,
        checks_performed: input.checks_performed ?? delivery.checks_performed,
        min_delay_change_threshold: input.min_delay_change_threshold ?? delivery.min_delay_change_threshold,
        min_hours_between_notifications: input.min_hours_between_notifications ?? delivery.min_hours_between_notifications,

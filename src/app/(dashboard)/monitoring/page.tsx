...
export default function MonitoringPage() {
  ...
  const { page, setPage, filter, setFilter } =
    useURLPaginationWithFilter<TrafficConditionFilter>("filter", "all");
      ...
      <div className="rounded-lg border bg-card shadow-sm overflow-hidden">
        ...
        <div className="p-4 sm:p-6 pt-0">
          {trafficLoading || routesLoading ? (
            ...
            <Alert variant="info">
              No routes available to display. Create deliveries to see traffic
              visualization.
            </Alert>
          )}
        </div>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <Button
          ...
          className={
            filter === "severe"
              ? ""
              : "hover:bg-red-50 hover:text-red-700 dark:hover:bg-red-950"
          }
        >
        ...
        <Button
          ...
          className={
            filter === "heavy"
              ? ""
              : "hover:bg-orange-50 hover:text-orange-700 dark:hover:bg-orange-950"
          }
        >
        ...
        <Button
          ...
          className={
            filter === "moderate"
              ? ""
              : "hover:bg-yellow-50 hover:text-yellow-700 dark:hover:bg-yellow-950"
          }
        >
        ...
        <Button
          ...
          className={
            filter === "light"
              ? ""
              : "hover:bg-green-50 hover:text-green-700 dark:hover:bg-green-950"
          }
        >
          ...
          <div className="max-h-[800px] overflow-y-auto">
            <List>
              {snapshots.map((snapshot: TrafficSnapshot) => {
                const route: Route | undefined = routeMap.get(
                  snapshot.route_id,
                );
                    ...
                    <div className="flex items-start gap-4 w-full">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground mb-2">
                          To:{" "}
                          {route?.destination_address ?? "Unknown Destination"}
                        </p>
                        ...
                        <div className="flex items-center gap-4 mt-2 flex-wrap text-xs">
                          <span
                            className={`font-medium ${enriched.config.color}`}
                          >
                            ...
                            <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
                              <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="text-sm font-medium text-blue-900 dark:text-blue-100">
                                  Affected Deliveries (
                                  {snapshot.affected_deliveries.length})
                                </span>
                              </div>
                              <div className="space-y-1">
                                ...
                                {snapshot.affected_deliveries.length > 3 && (
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() =>
                                      expandedDeliveries.toggle(snapshot.id)
                                    }
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <Badge
                      variant={enriched.config.variant}
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-xs pt-2">
                      ...
                      <span className={enriched.config.color}>
                        +{enriched.delay_minutes} min delay
                      </span>
                    </div>

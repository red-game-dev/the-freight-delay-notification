      ...
      <div className={cn(fullWidth && 'w-full')}>
        ...
        <div className="relative">
          <select
            ...
            aria-invalid={!!error}
            aria-describedby={
              error ? `${actualId}-error` : helperText ? `${actualId}-helper` : undefined
            }
            className={cn(
        ...
        {error && (
          <div className="flex items-center gap-1.5 mt-1.5">
            ...
            <p id={`${actualId}-error`} className="text-sm text-red-600 dark:text-red-400">
              {error}
            </p>
          </div>
        )}
        ...
        {helperText && !error && (
          <p id={`${actualId}-helper`} className="text-sm text-gray-600 dark:text-gray-400 mt-1.5">
            {helperText}
          </p>
        )}
      </div>

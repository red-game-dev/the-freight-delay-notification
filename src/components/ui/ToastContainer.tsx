...
const variantConfig = {
  ...
  critical: {
    icon: AlertCircle,
    className: 'bg-red-100 dark:bg-red-900/40 border-red-300 dark:border-red-700 text-red-900 dark:text-red-100',
  },
};
...
export function ToastContainer() {
  ...
  const toasts: ToastItem[] = React.useMemo(() => {
    ...
    return [...errorToasts, ...notificationToasts].sort((a, b) => b.data.timestamp - a.data.timestamp);

                              ...
                              <>
                                ...
                                <div>
                                  ...
                                  <span className="ml-2 font-medium">
                                    ...
                                    / {settings.min_delay_change_threshold}min
                                    change
                                  </span>
                                </div>
                              </>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                {running.map((execution: Workflow) => {
                  const config = statusConfig[execution.status];
                  const Icon = config.icon;
                  const isRecurring = execution.workflow_id
                    ? isWorkflowType(
                    ...
                    >
                      <Card className="p-4 hover:shadow-lg transition-shadow cursor-pointer h-full">
                            ...
                            <div className="flex flex-col">
                              <span className="font-semibold text-sm truncate">
                                {execution.tracking_number ||
                                  execution.delivery_id.substring(0, 8)}
                              </span>
                              {isRecurring && (
                        ...
                        <div className="space-y-2 text-xs">
                          ...
                          {execution.settings?.checks_performed !==
                            undefined && (
                            <div className="text-muted-foreground">
                              Progress: {execution.settings.checks_performed}/
                              {execution.settings.max_checks === -1
                                ? "∞"
                                : execution.settings.max_checks}{" "}
                              checks
                            </div>
                          )}
                        </div>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-0.5">
                              <span className="font-medium text-sm truncate">
                                {execution.tracking_number ||
                                  execution.delivery_id.substring(0, 12)}
                              </span>
                              <Badge
